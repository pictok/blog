...
draft: false
summary: 'We embarked on a logo redesign journey for the Pic-Tok app, aiming to represent its core aspects while maintaining simplicity. We ultimately chose to focus on sound, a crucial element for visually impaired users.'
...
The main focus for this week was the logo and the prototyping, although the design team is also working on another project for this app. The design team's other big project is creating a video commercial for this app, so the process has begun for that as well.
