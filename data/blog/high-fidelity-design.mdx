---
title: 'High-Fidelity Design: PicTok App'
date: '2023-10-12'
lastmod: '2023-10-12'
tags: ['Visual Impairment', 'Design']
draft: false
summary: 'We encountered challenges in securing insights from the BCIT accessibility center but persisted by gathering information from other sources to improve the PicTok app for visually impaired users. Our work on the high-fidelity layout in Figma progressed smoothly, benefiting from an efficient 'atoms -> molecules -> organisms' approach for component creation. Our unwavering commitment to accessibility, including the use of plugins and features, ensures a user-friendly experience for the visually impaired, while they continue refining the high-fidelity mock-up for an enjoyable app.'
